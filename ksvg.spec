...
Version  : 6.6.0
Release  : 14
URL      : https://download.kde.org/stable/frameworks/6.6/ksvg-6.6.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.6/ksvg-6.6.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.6/ksvg-6.6.0.tar.xz.sig
...
%setup -q -n ksvg-6.6.0
cd %{_builddir}/ksvg-6.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726450948
mkdir -p clr-build
pushd clr-build
