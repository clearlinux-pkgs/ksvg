...
Source0  : https://download.kde.org/stable/frameworks/6.11/ksvg-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/ksvg-6.11.0.tar.xz.sig
...
%setup -q -n ksvg-6.11.0
cd %{_builddir}/ksvg-6.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739581734
mkdir -p clr-build
pushd clr-build
