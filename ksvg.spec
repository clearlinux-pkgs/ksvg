...
Source0  : https://download.kde.org/stable/frameworks/6.9/ksvg-6.9.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.9/ksvg-6.9.0.tar.xz.sig
...
%setup -q -n ksvg-6.9.0
cd %{_builddir}/ksvg-6.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735246679
mkdir -p clr-build
pushd clr-build
