...
Version  : 6.14.0
Release  : 22
URL      : https://download.kde.org/stable/frameworks/6.14/ksvg-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/ksvg-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/ksvg-6.14.0.tar.xz.sig
...
%setup -q -n ksvg-6.14.0
cd %{_builddir}/ksvg-6.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747184666
mkdir -p clr-build
pushd clr-build
